module ::Proxy::Monitoring::Icinga2
  class PluginConfiguration
    def load_classes
      ...
      require 'smart_proxy_monitoring_common/upload_queue'
    ...
    def load_dependency_injection_wirings(container_instance, settings)
      ...
      container_instance.singleton_dependency :upload_queue, lambda { ::Proxy::Monitoring::UploadQueue.new }
      container_instance.singleton_dependency :icinga2_api_observer, (lambda do
        ::Proxy::Monitoring::Icinga2::Icinga2ApiObserver.new(container_instance.get_dependency(:upload_queue))
      end)
      container_instance.singleton_dependency :icinga2_result_uploader, (lambda do
        ::Proxy::Monitoring::Icinga2::Icinga2ResultUploader.new(container_instance.get_dependency(:upload_queue))
      end)
      container_instance.singleton_dependency :icinga2_initial_importer, (lambda do
        ::Proxy::Monitoring::Icinga2::Icinga2InitialImporter.new(container_instance.get_dependency(:upload_queue))
      end)
    end
  end
end
